...
# eliminates either passing or rushing plays
data = data[~data['EventType'].str.contains('pass')]

# create a set of positions and list of plays associated with each position
position_set = set()
play_dict = {}
